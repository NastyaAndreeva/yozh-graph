...
export class Lock extends ethereum.SmartContract {
  ...
  transferAll(_addrs: Array<Address>, _tokensNumber: Array<BigInt>): boolean {
    let result = super.call(
      "transferAll",
      "transferAll(address[],uint256[]):(bool)",
      [
        ethereum.Value.fromAddressArray(_addrs),
        ethereum.Value.fromUnsignedBigIntArray(_tokensNumber)
      ]
    );
  ...
  try_transferAll(
    _addrs: Array<Address>,
    _tokensNumber: Array<BigInt>
  ): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "transferAll",
      "transferAll(address[],uint256[]):(bool)",
...
export class TransferAllCall__Inputs {
  ...
  get _tokensNumber(): Array<BigInt> {
